...
from app.services.activity_service import validate_activity_dates, create_activity, update_activity
...
def test_validate_activity_dates_valid(app, sample_event, sample_activity_data):
    ...
    with app.app_context():
        ...
        try:
            ...
            pytest.fail(
                f"validate_activity_dates lanzó una excepción inesperada: {e}")


def test_validate_activity_dates_start_before_event(app, sample_event, sample_activity_data):
    ...
    with app.app_context():
        ...
        sample_activity_data['start_datetime'] = datetime(
            2023, 12, 31, 10, 0, 0)
        ...
        assert 'La fecha de inicio de la actividad debe estar dentro del rango del evento' in str(
            exc_info.value)


def test_validate_activity_dates_end_after_event(app, sample_event, sample_activity_data):
...
def test_validate_activity_dates_start_after_end(app, sample_event, sample_activity_data):
    ...
    with app.app_context():
        ...
        sample_activity_data['start_datetime'], sample_activity_data['end_datetime'] = \
            sample_activity_data['end_datetime'], sample_activity_data['start_datetime']
...
def test_update_activity_change_event_invalid_dates(app, sample_event, sample_activity_data):
