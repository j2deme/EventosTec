...
def test_filter_by_event_id(client, auth_headers, sample_data):
    ...
    response = client.get(
        f'/api/attendances/?event_id={event1_id}',
...
def test_filter_by_activity_type(client, auth_headers, sample_data):
    ...
    response = client.get(
        '/api/attendances/?activity_type=Taller',
        headers=auth_headers
    )
...
def test_filter_by_search(client, auth_headers, sample_data):
    ...
    response = client.get(
        '/api/attendances/?search=Test Student',
        headers=auth_headers
    )
...
def test_filters_with_no_results(client, auth_headers, sample_data):
    ...
    response = client.get(
        '/api/attendances/?event_id=99999',
        headers=auth_headers
    )
...
def test_legacy_filters_still_work(client, auth_headers, sample_data):
    ...
    response = client.get(
        f'/api/attendances/?activity_id={activity_id}',
        headers=auth_headers
    )
    ...
    # Test status filter
    response = client.get(
        '/api/attendances/?status=Asistió',
        headers=auth_headers
    )
