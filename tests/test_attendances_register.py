...
def test_register_attendance_creates_attendance(client, sample_data, auth_headers):
    ...
    resp = client.post("/api/attendances/register", json=payload, headers=auth_headers)
...
def test_register_attendance_idempotent(client, sample_data, auth_headers):
    ...
    resp1 = client.post("/api/attendances/register", json=payload, headers=auth_headers)
    resp2 = client.post("/api/attendances/register", json=payload, headers=auth_headers)
