...
def upgrade():
    ...
    op.add_column("activities", sa.Column("speakers", sa.Text(), nullable=True))
    op.add_column("activities", sa.Column("target_audience", sa.Text(), nullable=True))
    op.add_column(
        "activities", sa.Column("knowledge_area", sa.String(length=100), nullable=True)
    )
