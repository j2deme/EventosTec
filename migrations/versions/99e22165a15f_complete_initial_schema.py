...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "activity_type",
            sa.Enum("Magistral", "Conferencia", "Taller", "Curso", "Otro"),
            nullable=False,
        ),
        sa.Column("location", sa.String(length=200), nullable=False),
        sa.Column(
            "modality", sa.Enum("Presencial", "Virtual", "Híbrido"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("Registrado", "Confirmado", "Asistió", "Ausente", "Cancelado"),
            nullable=True,
        ),
